package alternativa.tanks.gui
{
   ...
   public class AlertBugWindow extends Sprite
   {
      ...
      public function AlertBugWindow()
      {
		 ...
		 this.description.text = "Произошла ошибка в текущем игровом процессе, пожалуйста, перезагрузите страницу с игрой";
      ...
      {
			if (Network(Main.osgi.getService(INetworker)) != null && param1 != null)
			{
				Network(Main.osgi.getService(INetworker)).send("lobby;bug_report;" + param1 + ";");
			}
			this.redraw();
      }
