package forms.news.edit 
{
	...
	public class Nnews extends Sprite
	{
		...
		public function sdfee1(e:Event) : void
		{
			...
			Network(Main.osgi.getService(INetworker)).send("lobby;addnews;" + d.text + ";" + output.text + ";" + output1.text + ";");
		}
