package forms.shop.shopitems.item.crystalitem
{
   ...
   public class CrystalPackageButton extends ShopItemButton
   {
      ...
      public function CrystalPackageButton(param1:Number,param2:Number,param3:String)
      {
		 cr = param1;
		 pr = param2;
		 tr = param3;
      ...
      override protected function align() : void
      {
         ...
         priceLabel.y = this.crystalLabel.y + this.crystalLabel.height - 5;
         if(preview != null)
         {
